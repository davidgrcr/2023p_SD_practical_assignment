...
//	private transient LSimWorker lsim = LSimFactory.getWorkerInstance();
	...
	public TimestampVector clone(){		
	    ...
	    for (String participant : participants) {
	        clonedTimestampVector.updateTimestamp(this.getLast(participant));
	    }
	...
	public boolean equals(Object obj){
		...
		TimestampVector timestampVector = (TimestampVector) obj;
		return this.timestampVector.equals(timestampVector.timestampVector);
	}
